...
def cornflowerblue_pen():
	s1.color("cornflowerblue")
	
window.onkeypress(cornflowerblue_pen, "x")

def lightpink_pen():
	s1.color("lightpink")
	
window.onkeypress(lightpink_pen, "e")
...
def stop():
	s1.pendown()
window.onkeypress(stop, "t")

def start():
	s1.penup()
window.onkeyrelease(start, "t")
